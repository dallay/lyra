...
<template>
	...
	<h1 class="my-4 text-4xl font-extrabold">Mixed</h1>

	<section class="my-8">
		<h2 class="my-4 text-3xl font-bold">Line Column</h2>

		<XCard>
			<XChart :option="lineColumnChartOption" class="h-100 w-full" />
		</XCard>
	</section>

	<section class="my-8">
		<h2 class="my-4 pt-6 text-3xl font-bold">Line Scatter</h2>

		<XCard>
			<XChart :option="lineScatterChartOption" class="h-100 w-full" />
		</XCard>
	</section>
</template>
