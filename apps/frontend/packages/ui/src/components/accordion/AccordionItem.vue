...
<template>
	<div ref="self" class="w-full rounded bg-white shadow dark:bg-slate-800">
		<div
		...
		>
			...
			<div
				...
				class="i-ic-baseline-arrow-drop-down h-6 w-6"
			></div>
			<div v-else class="i-ic-baseline-arrow-drop-up h-6 w-6"></div>
		</div>
