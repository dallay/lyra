...
<template>
	...
	>
		<div v-if="children?.length" class="i-ic-baseline-arrow-drop-down h-6 w-6"></div>
		<div v-else class="i-mdi-dot h-6 w-6"></div>
		<div>{{ label }}</div>
	</div>
