 ...
 * It implements the [CommandHandler] interface with [OrganizationWorkspaceCommand] as the command type.
 *
...
class CreateOrganizationCommandHandler(
...
) : CommandHandler<OrganizationWorkspaceCommand> {
     ...
     *
     * @param command The [OrganizationWorkspaceCommand] containing the information needed to create an organization.
     */
    override suspend fun handle(command: OrganizationWorkspaceCommand) {
