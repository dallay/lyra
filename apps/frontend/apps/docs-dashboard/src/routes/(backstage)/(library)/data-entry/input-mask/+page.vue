...
<template>
	...
	<h1 class="my-4 text-4xl font-extrabold">InputMask</h1>

	<section class="my-8">
		<h2 class="my-4 text-3xl font-bold">Number</h2>
	...
	<section class="my-8">
		<h2 class="my-4 pt-6 text-3xl font-bold">Percent</h2>
	...
	<section class="my-8">
		<h2 class="my-4 pt-6 text-3xl font-bold">Phone</h2>
	...
	<section class="my-8">
		<h2 class="my-4 pt-6 text-3xl font-bold">Currency</h2>
