...
<template>
	...
	<h1 class="my-4 text-4xl font-extrabold">Map</h1>

	<section class="my-8">
		<h2 class="my-4 text-3xl font-bold">Countries-110m</h2>

		<XCard>
			<XChart :option="mapChartOption" class="min-h-100 h-75dvh w-full" />
		</XCard>
	</section>
</template>
