...
<template>
	...
	<div class="mb-8 mt-4 flex flex-col gap-2">
...
.card {
	@apply relative col-span-1 rounded border border-slate-400 bg-slate-50 p-2 dark:border-slate-600 dark:bg-slate-900;
	@apply hover:important:border-transparent after:-z-1 after:absolute after:hidden after:rounded after:content-[''] hover:after:block;
