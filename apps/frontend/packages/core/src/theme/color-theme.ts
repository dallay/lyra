 ...
 */
export const isDarkMode = (key: string = DEFAULT_KEY,
                           darkThemeClass: string = DARK_THEME): boolean => {
  const theme = localStorage.getItem(key);
  return theme === darkThemeClass || (!theme && window.matchMedia('(prefers-color-scheme: dark)').matches);
};
/**
 ...
 * @returns void
 */
export const loadTheme = (key: string = DEFAULT_KEY,
                          darkThemeClass: string = DARK_THEME,
                          lightThemeClass: string = LIGHT_THEME,
): void => {
  const theme = localStorage.getItem(key);
  if (theme === darkThemeClass || (!theme && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
 ...
 * @returns void
 */
export const toggleTheme = (key: string = DEFAULT_KEY,
                            darkThemeClass: string = DARK_THEME,
                            lightThemeClass: string = LIGHT_THEME,
): void => {
