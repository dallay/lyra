 ...
 * It implements the [CommandHandler] interface with [CreateOrganizationCommand] as the command type.
 *
...
class CreateOrganizationCommandHandler(
     ...
     *
     * @param command The [CreateOrganizationCommand] containing the information needed to create an organization.
     */
    override suspend fun handle(command: CreateOrganizationCommand) {
