...
<template>
	...
	<h1 class="my-4 text-4xl font-extrabold">TreeTable</h1>
	...
	<div class="TreeTable-Wrapper">
		<table class="TreeTable-Element">
			<thead>
				<tr>
					<XTable.Column>
						<div class="min-h-38px inline-flex items-center">Name</div>
					</XTable.Column>
					<XTable.Column>
						<div class="min-h-38px inline-flex items-center">Size</div>
					</XTable.Column>
					<XTable.Column>
						<div class="min-h-38px inline-flex items-center">Type</div>
					</XTable.Column>
				</tr>
			</thead>
...
.TreeTable-Element {
	@apply w-full border-collapse items-center;
}
</style>
