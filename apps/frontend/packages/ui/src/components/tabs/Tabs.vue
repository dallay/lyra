		...
		>
			<template v-for="(tab, idx) in tabs" :key="idx">
				...
				>
					...
					<div
						v-if="closeable"
						class="i-fa-close ml-3 h-3 w-3 transition hover:scale-125"
...
.Tabs-Tab {
	@apply flex cursor-pointer items-center border-b-2 border-transparent px-7 pb-3.5 pt-4;
	@apply whitespace-nowrap font-medium uppercase leading-tight text-neutral-500;
