...
<template>
	...
	>
		<div class="flex w-full">
			<div v-if="icon">
				<div class="mr-3 h-6 w-6" :class="icon"></div>
			</div>
			...
			<div class="ml-3 flex h-6 w-6 items-center justify-center">
				<div
					class="i-fa-times h-3 w-3 cursor-pointer transition hover:scale-125"
...
.Alert {
	@apply flex justify-between rounded-lg border border-current p-4 backdrop-blur-2xl;
