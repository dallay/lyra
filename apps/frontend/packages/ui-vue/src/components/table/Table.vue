            ...
            >
              ...
              >
                ...
                <template v-if="typeof col.sortable === 'boolean' ? col.sortable : true">
                  <div>
                    <SvgIcon  v-if="flux.sortField === col.key && flux.sortDirection === 'desc'"
                              name="sort-down" class="w-3.5 h-3.5" />
                    <SvgIcon  v-else-if="flux.sortField === col.key && flux.sortDirection === 'asc'"
                              name="sort-up" class="w-3.5 h-3.5" />
                    <SvgIcon  v-else
                              name="sort" class="w-3.5 h-3.5" />
                  </div>
                </template>
              </div>
            </Column>
